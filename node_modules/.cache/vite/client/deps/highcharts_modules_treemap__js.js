    ...
    */
    function(t) {
      ...
      i(e, "Extensions/Breadcrumbs/BreadcrumbsDefaults.js", [], function() {
        ...
        let { format: r } = e2, { composed: o } = i2, { addEvent: l, defined: n, extend: a, fireEvent: h, isString: d, merge: p, objectEach: u, pick: c, pushUnique: g } = s;
        function m() {
          if (this.breadcrumbs) {
        ...
        class x {
          static compose(e3, i3) {
            g(o, "Breadcrumbs") && (l(e3, "destroy", v), l(e3, "afterShowResetZoom", m), l(e3, "getMargins", b), l(e3, "redraw", f), l(e3, "selection", y), a(i3.lang, t2.lang));
          }
          constructor(t3, e3) {
          ...
          getButtonText(t3) {
            let e3 = this.chart, i3 = this.options, s2 = e3.options.lang, o2 = c(i3.format, i3.showFullPath ? "{level.name}" : "← {level.name}"), l2 = s2 && c(s2.drillUpText, s2.mainBreadcrumb), a2 = i3.formatter && i3.formatter(t3) || r(o2, { level: t3.levelOptions }, e3) || "";
            return (d(a2) && !a2.length || "← " === a2) && n(l2) && (a2 = i3.showFullPath ? l2 : "← " + l2), a2;
          }
          redraw() {
          ...
          alignBreadcrumbsGroup(t3) {
            if (this.group) {
              ...
              let n2 = p(s2);
              t3 && (n2.x += t3), this.options.rtl && (n2.x += s2.width), n2.y = c(n2.y, this.yOffset, 0), this.group.align(n2, true, r2);
            }
          }
          renderButton(t3, e3, i3) {
            let s2 = this, r2 = this.chart, o2 = s2.options, l2 = p(o2.buttonTheme), n2 = r2.renderer.button(s2.getButtonText(t3), e3, i3, function(e4) {
              let i4;
            ...
            return r2.styledMode || n2.attr(o2.style), n2;
          }
          ...
          updateListElements() {
            ...
            }, n2 = this.group ? o2(this.group, e3) : e3, a2, h2;
            for (let d2 = 0, p2 = i3.length; d2 < p2; ++d2) {
              let u2, c2;
              let g2 = d2 === p2 - 1;
              t3[(h2 = i3[d2]).level] ? (u2 = (a2 = t3[h2.level]).button, a2.separator || g2 ? a2.separator && g2 && (a2.separator.destroy(), delete a2.separator) : (n2 += r2 * e3, a2.separator = this.renderSeparator(n2, e3), s2 && l2(a2.separator, n2, e3), n2 += o2(a2.separator, e3)), t3[h2.level].updated = true) : (u2 = this.renderButton(h2, n2, e3), s2 && l2(u2, n2, e3), n2 += o2(u2, e3), g2 || (c2 = this.renderSeparator(n2, e3), s2 && l2(c2, n2, e3), n2 += o2(c2, e3)), t3[h2.level] = { button: u2, separator: c2, updated: true }), u2 && u2.setState(g2 ? 2 : 0);
            }
          }
        }
        ...
        return { draw: function(t2, e2) {
          let { animatableAttribs: i2, onComplete: s, css: r, renderer: o } = e2, l = t2.series && t2.series.chart.hasRendered ? void 0 : t2.series && t2.series.options.animation, n = t2.graphic;
          if (e2.attribs = { ...e2.attribs, class: t2.getClassName() }, t2.shouldDraw()) n || (n = "text" === e2.shapeType ? o.text() : "image" === e2.shapeType ? o.image(e2.imageUrl || "").attr(e2.shapeArgs || {}) : o[e2.shapeType](e2.shapeArgs || {}), t2.graphic = n, n.add(e2.group)), r && n.css(r), n.attr(e2.attribs).animate(i2, !e2.isNew && l, s);
          else if (n) {
            let e3 = () => {
              t2.graphic = n = n && n.destroy(), "function" == typeof s && s();
            };
            Object.keys(i2).length ? n.animate(i2, void 0, () => e3()) : e3();
          }
        } };
        ...
        let { pie: { prototype: { pointClass: s } }, scatter: { prototype: { pointClass: r } } } = e2.seriesTypes, { extend: o, isNumber: l, pick: n } = i2;
        class a extends r {
          constructor() {
          ...
          getClassName() {
            ...
            return this.node.level <= t3.nodeMap[t3.rootNode].level && this.node.children.length ? i3 += " highcharts-above-level" : this.node.isLeaf || n(e3.interactByLeaf, !e3.allowTraversingTree) ? this.node.isLeaf || (i3 += " highcharts-internal-node") : i3 += " highcharts-internal-node-interactive", i3;
          }
          isValid() {
        ...
        return o(a.prototype, { setVisible: s.prototype.setVisible }), a;
        ...
        let { extend: i2, isArray: s, isNumber: r, isObject: o, merge: l, pick: n, relativeLength: a } = e2;
        return { getColor: function(e3, i3) {
          let s2, r2, o2, l2, a2, h;
          let d = i3.index, p = i3.mapOptionsToLevel, u = i3.parentColor, c = i3.parentColorIndex, g = i3.series, m = i3.colors, v = i3.siblings, b = g.points, f = g.chart.options.chart;
          return e3 && (s2 = b[e3.i], r2 = p[e3.level] || {}, s2 && r2.colorByPoint && (l2 = s2.index % (m ? m.length : f.colorCount), o2 = m && m[l2]), g.chart.styledMode || (a2 = n(s2 && s2.options.color, r2 && r2.color, o2, u && ((e4) => {
            let i4 = r2 && r2.colorVariation;
            return i4 && "brightness" === i4.key && d && v ? t2.parse(e4).brighten(i4.to * (d / v)).get() : e4;
          })(u), g.color)), h = n(s2 && s2.options.colorIndex, r2 && r2.colorIndex, l2, c, i3.colorIndex)), { color: a2, colorIndex: h };
          ...
          if (o(t3)) for (h = r(t3.from) ? t3.from : 1, p = t3.levels, i3 = {}, e3 = o(t3.defaults) ? t3.defaults : {}, s(p) && (i3 = p.reduce((t4, i4) => {
            let s2, a3, d2;
            return o(i4) && r(i4.level) && (a3 = n((d2 = l({}, i4)).levelIsConstant, e3.levelIsConstant), delete d2.levelIsConstant, delete d2.level, o(t4[s2 = i4.level + (a3 ? 0 : h - 1)]) ? l(true, t4[s2], d2) : t4[s2] = d2), t4;
          }, {})), d = r(t3.to) ? t3.to : 1, a2 = 0; a2 <= d; a2++) u[a2] = l({}, e3, o(i3[a2]) ? i3[a2] : {});
          return u;
          ...
          let r2 = s2.before, o2 = s2.idRoot, l2 = s2.mapIdToNode[o2], a2 = false !== s2.levelIsConstant, h = s2.points[e3.i], d = h && h.options || {}, p = [], u = 0;
          e3.levelDynamic = e3.level - (a2 ? 0 : l2.level), e3.name = n(h && h.name, ""), e3.visible = o2 === e3.id || true === s2.visible, "function" == typeof r2 && (e3 = r2(e3, s2)), e3.children.forEach((r3, o3) => {
            let l3 = i2({}, s2);
          ...
          let e3, i3;
          return o(t3) && (i3 = o(t3.options) ? t3.options : {}, e3 = n(t3.rootNode, i3.rootId, ""), o(t3.userOptions) && (t3.userOptions.rootId = e3), t3.rootNode = e3), e3;
        } };
      }), i(e, "Series/Treemap/TreemapSeries.js", [e["Extensions/Breadcrumbs/Breadcrumbs.js"], e["Core/Color/Color.js"], e["Series/ColorMapComposition.js"], e["Core/Globals.js"], e["Core/Series/SeriesRegistry.js"], e["Series/Treemap/TreemapAlgorithmGroup.js"], e["Series/Treemap/TreemapNode.js"], e["Series/Treemap/TreemapPoint.js"], e["Series/Treemap/TreemapSeriesDefaults.js"], e["Series/Treemap/TreemapUtilities.js"], e["Series/TreeUtilities.js"], e["Core/Utilities.js"]], function(t2, e2, i2, s, r, o, l, n, a, h, d, p) {
        let { parse: u } = e2, { composed: c, noop: g } = s, { column: m, scatter: v } = r.seriesTypes, { getColor: b, getLevelOptions: f, updateRootId: y } = d, { addEvent: x, correctFloat: T, crisp: w, defined: B, error: S, extend: C, fireEvent: L, isArray: P, isObject: A, isString: O, merge: R, pick: D, pushUnique: j, stableSort: M } = p, N = false;
        function I() {
          let t3;
          let e3 = this.xAxis, i3 = this.yAxis;
          e3 && i3 && (this.is("treemap") ? (t3 = { endOnTick: false, gridLineWidth: 0, lineWidth: 0, min: 0, minPadding: 0, max: 100, maxPadding: 0, startOnTick: false, title: void 0, tickPositions: [] }, C(i3.options, t3), C(e3.options, t3), N = true) : N && (i3.setOptions(i3.userOptions), e3.setOptions(e3.userOptions), N = false));
        }
        class U extends v {
          static compose(t3) {
            j(c, "TreemapSeries") && x(t3, "afterBindAxes", I);
          }
          algorithmCalcPoints(t3, e3, i3, s2) {
            let r2 = i3.plot, o2 = i3.elArr.length - 1, l2, n2, a2, h2, d2 = i3.lW, p2 = i3.lH, u2, c2 = 0;
            for (let t4 of (e3 ? (d2 = i3.nW, p2 = i3.nH) : u2 = i3.elArr[o2], i3.elArr)) (e3 || c2 < o2) && (0 === i3.direction ? (l2 = r2.x, n2 = r2.y, h2 = t4 / (a2 = d2)) : (l2 = r2.x, n2 = r2.y, a2 = t4 / (h2 = p2)), s2.push({ x: l2, y: n2, width: a2, height: T(h2) }), 0 === i3.direction ? r2.y = r2.y + h2 : r2.x = r2.x + a2), c2 += 1;
          ...
          algorithmFill(t3, e3, i3) {
            let s2 = [], r2, o2 = e3.direction, l2 = e3.x, n2 = e3.y, a2 = e3.width, h2 = e3.height, d2, p2, u2, c2;
            for (let g2 of i3) r2 = e3.width * e3.height * (g2.val / e3.val), d2 = l2, p2 = n2, 0 === o2 ? (a2 -= u2 = r2 / (c2 = h2), l2 += u2) : (h2 -= c2 = r2 / (u2 = a2), n2 += c2), s2.push({ x: d2, y: p2, width: u2, height: c2 }), t3 && (o2 = 1 - o2);
            return s2;
          }
          algorithmLowAspectRatio(t3, e3, i3) {
            let s2 = [], r2 = { x: e3.x, y: e3.y, parent: e3 }, l2 = e3.direction, n2 = i3.length - 1, a2 = new o(e3.height, e3.width, l2, r2), h2, d2 = 0;
            for (let o2 of i3) h2 = e3.width * e3.height * (o2.val / e3.val), a2.addElement(h2), a2.lP.nR > a2.lP.lR && this.algorithmCalcPoints(t3, false, a2, s2, r2), d2 === n2 && this.algorithmCalcPoints(t3, true, a2, s2, r2), ++d2;
            return s2;
          }
          alignDataLabel(t3, e3, i3) {
            let s2 = i3.style;
            s2 && !B(s2.textOverflow) && e3.text && e3.getBBox().width > (e3.text.textWidth || 0) && e3.css({ textOverflow: "ellipsis", width: s2.width += "px" }), m.prototype.alignDataLabel.apply(this, arguments), t3.dataLabel && t3.dataLabel.attr({ zIndex: (t3.node.zIndex || 0) + 1 });
          }
          calculateChildrenAreas(t3, e3) {
            let i3 = this.options, s2 = this.mapOptionsToLevel[t3.level + 1], r2 = D(this[s2 && s2.layoutAlgorithm] && s2.layoutAlgorithm, i3.layoutAlgorithm), o2 = i3.alternateStartingDirection, l2 = t3.children.filter((t4) => !t4.ignore), n2 = [];
            s2 && s2.layoutStartingDirection && (e3.direction = "vertical" === s2.layoutStartingDirection ? 0 : 1), n2 = this[r2](e3, l2);
            let a2 = -1;
            for (let t4 of l2) {
              let i4 = n2[++a2];
              t4.values = R(i4, { val: t4.childrenTotal, direction: o2 ? 1 - e3.direction : e3.direction }), t4.pointValues = R(i4, { x: i4.x / this.axisRatio, y: 100 - i4.y - i4.height, width: i4.width / this.axisRatio }), t4.children.length && this.calculateChildrenAreas(t4, t4.values);
            }
          }
          createList(t3) {
          ...
          drawDataLabels() {
            ...
            })) e3 = i3[s2.node.level], t3 = { style: {} }, s2.node.isLeaf || (t3.enabled = false), e3 && e3.dataLabels && (t3 = R(t3, e3.dataLabels), this.hasDataLabels = () => true), s2.shapeArgs && (t3.style.width = s2.shapeArgs.width, s2.dataLabel && s2.dataLabel.css({ width: s2.shapeArgs.width + "px" })), s2.dlOptions = R(t3, s2.options.dataLabels);
            super.drawDataLabels();
          }
          drawPoints(t3 = this.points) {
            let e3 = this.chart, i3 = e3.renderer, s2 = e3.styledMode, r2 = this.options, o2 = s2 ? {} : r2.shadow, l2 = r2.borderRadius, n2 = e3.pointCount < r2.animationLimit, a2 = r2.allowTraversingTree;
            for (let e4 of t3) {
              let t4 = e4.node.levelDynamic, h2 = {}, d2 = {}, p2 = {}, u2 = "level-group-" + e4.node.level, c2 = !!e4.graphic, g2 = n2 && c2, m2 = e4.shapeArgs;
              e4.shouldDraw() && (e4.isInside = true, l2 && (d2.r = l2), R(true, g2 ? h2 : d2, c2 ? m2 : {}, s2 ? {} : this.pointAttribs(e4, e4.selected ? "select" : void 0)), this.colorAttribs && s2 && C(p2, this.colorAttribs(e4)), this[u2] || (this[u2] = i3.g(u2).attr({ zIndex: 1e3 - (t4 || 0) }).add(this.group), this[u2].survive = true)), e4.draw({ animatableAttribs: h2, attribs: d2, css: p2, group: this[u2], imageUrl: e4.imageUrl, renderer: i3, shadow: o2, shapeArgs: m2, shapeType: e4.shapeType }), a2 && e4.graphic && (e4.drillId = r2.interactByLeaf ? this.drillToByLeaf(e4) : this.drillToByGroup(e4));
            }
          }
          drillToByGroup(t3) {
            let e3 = false;
          ...
          drillToNode(t3, e3) {
            S(32, false, void 0, { "treemap.drillToNode": "use treemap.setRootNode" }), this.setRootNode(t3, e3);
          }
          drillUp() {
            let t3 = this.nodeMap[this.rootNode];
            t3 && O(t3.parent) && this.setRootNode(t3.parent, true, { trigger: "traverseUpButton" });
          }
          getExtremes() {
          ...
          getListOfParents(t3, e3) {
            let i3 = P(t3) ? t3 : [], s2 = P(e3) ? e3 : [], r2 = i3.reduce(function(t4, e4, i4) {
              let s3 = D(e4.parent, "");
          ...
          buildTree(t3, e3, i3, s2, r2) {
            let o2 = [], l2 = this.points[e3], n2 = 0, a2;
            for (let e4 of s2[t3] || []) n2 = Math.max((a2 = this.buildTree(this.points[e4].id, e4, i3 + 1, s2, t3)).height + 1, n2), o2.push(a2);
            let h2 = new this.NodeClass().init(t3, e3, o2, n2, i3, this, r2);
          ...
          init(e3, i3) {
            let s2 = this, r2 = R(i3.drillUpButton, i3.breadcrumbs), o2 = x(s2, "setOptions", (t3) => {
              let e4 = t3.userOptions;
              B(e4.allowDrillToNode) && !B(e4.allowTraversingTree) && (e4.allowTraversingTree = e4.allowDrillToNode, delete e4.allowDrillToNode), B(e4.drillUpButton) && !B(e4.traverseUpButton) && (e4.traverseUpButton = e4.drillUpButton, delete e4.drillUpButton);
            });
          ...
          onClickDrillToNode(t3) {
            ...
            O(i3) && (e3.setState(""), this.setRootNode(i3, true, { trigger: "click" }));
          }
          pointAttribs(t3, e3) {
            let i3;
            let s2 = A(this.mapOptionsToLevel) ? this.mapOptionsToLevel : {}, r2 = t3 && s2[t3.node.level] || {}, o2 = this.options, l2 = e3 && o2.states && o2.states[e3] || {}, n2 = t3 && t3.getClassName() || "", a2 = { stroke: t3 && t3.borderColor || r2.borderColor || l2.borderColor || o2.borderColor, "stroke-width": D(t3 && t3.borderWidth, r2.borderWidth, l2.borderWidth, o2.borderWidth), dashstyle: t3 && t3.borderDashStyle || r2.borderDashStyle || l2.borderDashStyle || o2.borderDashStyle, fill: t3 && t3.color || this.color };
            return -1 !== n2.indexOf("highcharts-above-level") ? (a2.fill = "none", a2["stroke-width"] = 0) : -1 !== n2.indexOf("highcharts-internal-node-interactive") ? (i3 = D(l2.opacity, o2.opacity), a2.fill = u(a2.fill).setOpacity(i3).get(), a2.cursor = "pointer") : -1 !== n2.indexOf("highcharts-internal-node") ? a2.fill = "none" : e3 && (a2.fill = u(a2.fill).brighten(l2.brightness).get()), a2;
          }
          setColorRecursive(t3, e3, i3, s2, r2) {
            let o2 = this && this.chart, l2 = o2 && o2.options && o2.options.colors;
            if (t3) {
              let o3 = b(t3, { colors: l2, index: s2, mapOptionsToLevel: this.mapOptionsToLevel, parentColor: e3, parentColorIndex: i3, series: this, siblings: r2 }), n2 = this.points[t3.i];
              n2 && (n2.color = o3.color, n2.colorIndex = o3.colorIndex);
              let a2 = -1;
              for (let e4 of t3.children || []) this.setColorRecursive(e4, o3.color, o3.colorIndex, ++a2, t3.children.length);
            }
          }
          setPointValues() {
            ...
            for (let t4 of e3) {
              ...
              if (e4 && r3) {
                let { height: r4, width: l2, x: n2, y: a2 } = e4, h2 = o2(t4), d2 = w(i3.toPixels(n2, true), h2, true), p2 = w(i3.toPixels(n2 + l2, true), h2, true), u2 = w(s2.toPixels(a2, true), h2, true), c2 = w(s2.toPixels(a2 + r4, true), h2, true), g2 = { x: Math.min(d2, p2), y: Math.min(u2, c2), width: Math.abs(p2 - d2), height: Math.abs(c2 - u2) };
          ...
          setRootNode(t3, e3, i3) {
            L(this, "setRootNode", C({ newRootId: t3, previousRootId: this.rootNode, redraw: D(e3, true), series: this }, i3), function(t4) {
              let e4 = t4.series;
          ...
          setTreeValues(t3) {
            let e3 = this.options, i3 = this.rootNode, s2 = this.nodeMap[i3], r2 = "boolean" != typeof e3.levelIsConstant || e3.levelIsConstant, o2 = [], l2 = this.points[t3.i], n2 = 0;
            for (let e4 of t3.children) e4 = this.setTreeValues(e4), o2.push(e4), e4.ignore || (n2 += e4.val);
            M(o2, (t4, e4) => (t4.sortIndex || 0) - (e4.sortIndex || 0));
            let a2 = D(l2 && l2.options.value, n2);
            return l2 && (l2.value = a2), C(t3, { children: o2, childrenTotal: n2, ignore: !(D(l2 && l2.visible, true) && a2 > 0), isLeaf: t3.visible && !n2, levelDynamic: t3.level - (r2 ? 0 : s2.level), name: D(l2 && l2.name, ""), sortIndex: D(l2 && l2.sortIndex, -a2), val: a2 }), t3;
          }
          sliceAndDice(t3, e3) {
          ...
          translate() {
            ...
            super.translate();
            let n2 = t3.tree = t3.getTree();
            s2 = t3.nodeMap[i3], "" === i3 || s2 || (t3.setRootNode("", false), i3 = t3.rootNode, s2 = t3.nodeMap[i3]), t3.mapOptionsToLevel = f({ from: s2.level + 1, levels: e3.levels, to: n2.height, defaults: { levelIsConstant: t3.options.levelIsConstant, colorByPoint: e3.colorByPoint } }), h.recursive(t3.nodeMap[t3.rootNode], (e4) => {
