          ...
          renderElements() {
            ...
            if ([!i3, i3, !i3].forEach((i4, o3) => {
              ...
              [0, 1].forEach((e4) => {
                ...
                } else t3.handles[e4] = r2.symbol(h2, -l2 / 2 - 1, 0, l2, o3, i4), t3.handles[e4].attr({ zIndex: 7 - e4 }).addClass("highcharts-navigator-handle highcharts-navigator-handle-" + ["left", "right"][e4]).add(n2);
...
//# sourceMappingURL=highcharts_modules_stock__js.js.map
